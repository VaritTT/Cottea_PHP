...
$orderStatus = " WHERE order_status_id = 2";
                    ...
                    <?php while ($row = mysqli_fetch_array($result)){ ?>
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="<?=ROOT?>/order_status_update?order_id=<?= $row['order_id'] ?>&new_status=3" class="btn btn-warning btn-sm">อัพเดตสถานะ</a>
                                <a href="#" class="btn btn-success btn-sm">ออกใบกำกับภาษี</a>
                            </td>
                        </tr>
                    <?php }; ?>
                </tbody>
